...
set LinkerFlags=/NODEFAULTLIB:MSVCRT /SUBSYSTEM:console /LIBPATH:w:\deps\SDL2\lib\ /LIBPATH:w:\deps\nlopt\lib\ SDL2.lib SDL2main.lib nlopt.lib opengl32.lib user32.lib gdi32.lib opengl32.lib kernel32.lib
set Files=w:\src\main.cpp w:\src\gl.cpp w:\deps\glad\glad.c w:\deps\imgui\imgui_compile.cpp w:\deps\bhtsne\sp_tsne.cpp w:\deps\bhtsne\sptree.cpp
