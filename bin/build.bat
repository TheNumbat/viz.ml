...
set LinkerFlags=/NODEFAULTLIB:MSVCRT /SUBSYSTEM:windows /LIBPATH:w:\deps\SDL2\lib\ SDL2.lib SDL2main.lib opengl32.lib user32.lib gdi32.lib opengl32.lib kernel32.lib
